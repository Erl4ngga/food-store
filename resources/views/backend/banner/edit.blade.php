...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}">
        ...
        <input id="inputTitle" type="text" name="url" placeholder="Url"  value="{{$banner->url}}" class="form-control">
        @error('title')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input id="thumbnail2" class="form-control" type="text" name="photo2" value="{{$banner->photo2}}">
          </div>
          <div id="holder" style="margin-top:15px;max-height:100px;"></div>
            @error('photo')
            <span class="text-danger">{{$message}}</span>
