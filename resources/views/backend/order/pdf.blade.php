...
<style type="text/css">
  ...
  <div class="invoice-description">
    ...
    <div class="invoice-right-top float-right" class="text-right">
      <h3>No ID #{{$order->order_number}}</h3>
    ...
    <table class="table table-bordered table-stripe">
      <thead>
        <tr>
          ...
          <th scope="col" class="col-6">Size</th>
          <th scope="col" class="col-3">color</th>
          <th scope="col" class="col-3">Total</th>
          <th scope="col" class="col-3">Total amount</th>
        </tr>
      </thead>
      <tbody>
      ...
      @php 
        ...
        $size = DB::table('products')->select('size')->where('id', $cart->product_id)->first();
        $rgb = DB::table('products')->select('rgb')->where('id', $cart->product_id)->first();
      @endphp
        <tr>
          <td><span>
          ...
          <td><span>
            @if (!is_null($rgb) && !is_null($rgb->rgb))
                 <div style="background-color: {{ $rgb->rgb }}; width: 50px; height: 50px;"></div>
            @else
            no color
            @endif
          </span></td>
      ...
      <tfoot>
        ...
        <tr>
          ...
          @endphp
          <th scope="col" class="text-right ">Postage:</th>
