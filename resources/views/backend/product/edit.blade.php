...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="inputcurrency" class="col-form-label">Symbol currency($,Rp,£,etc) <span class="text-danger">*</span></label>
          <input id="inputcurrency" type="text" name="currency" placeholder="Enter currency"  value="{{$product->currency}}" class="form-control">
          @error('currency')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          {!! Form::label('rgb', 'RGB') !!}
          {!! Form::input('color', 'rgb', null, ['class' => 'form-control']) !!}
        </div>
        <div class="form-group">
          <label for="countdown_date">Countdown Date</label>
          <input type="date" name="countdown_date" value="{{$product->countdown_date}}" class="form-control">
        </div>
        <div class="form-group">
          <label for="countdown_time">Countdown Time</label>
          <input type="time" name="countdown_time" value="{{$product->countdown_time}}" class="form-control">
        </div>
        <div class="form-group">
          <label for="countdown_duration">Countdown Duration (in seconds)</label>
          <input type="number" name="countdown_duration" value="{{$product->countdown_duration}}" class="form-control">
        </div>
        <div class="form-group">
