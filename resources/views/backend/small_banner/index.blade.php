...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('small-banner.create')}}" class="btn btn-pink btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Small Banner</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($banners as $banner)   
                <tr>
                    ...
                    <td>
                        <a href="{{route('small-banner.edit',$banner->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                        <form method="POST" action="{{route('small-banner.destroy',[$banner->id])}}">
                          @csrf 
                          @method('delete')
