...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="short_des" class="col-form-label">Short Description/About Us <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">Logo (300x300)<span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">Header Photo <span class="text-danger">*</span></label>
          <div class="input-group">
              <span class="input-group-btn">
        ...
        <div class="form-group">
          <label for="linkedin" class="col-form-label">linkedin<span class="text-danger">*</span></label>
