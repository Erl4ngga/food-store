<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top header-image shadow">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right border-left-primary animated--grow-in"
