...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800" style="text-shadow: 2px 2px 4px gray;">Dashboard</h1>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card background-image border-left-primary h-100 py-2">
          <div class="card-body">
        ...
        <div class="card background-image border-left-primary h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              ...
              <div class="col-auto">
                <i class="fas fa-cubes fa-2x" style="color: black;"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card background-image border-left-primary h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              ...
              <div class="col-auto">
                <i class="fa fa-chart-bar fa-2x " style="color: black;"></i>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="col-xl-8 col-lg-7">
      <div class="card border-left-primary mb-4">
        <!-- Card Header - Dropdown -->
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Earnings Transaction</h6>
          
        </div>
        <!-- Card Body -->
        <div class="card-body">
          <div class="chart-area">
            <canvas id="myTransactionAreaChart"></canvas>
          </div>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
    var route = "{{route('product.transaction.income')}}";
    // Set new default font family and font color to mimic Bootstrap's default styling
    Chart.defaults.global.defaultFontFamily = 'Nunito', '-apple-system,system-ui,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif';
    Chart.defaults.global.defaultFontColor = '#858796';
    ...
    function number_format(number, decimals, dec_point, thousands_sep) {
      ...
      // Area Chart Example
      var ct = document.getElementById("myTransactionAreaChart");

        axios.get(route)
              .then(function (response) {
                const data_key = Object.keys(response.data);
                const data_value = Object.values(response.data);
                var myLineChart = new Chart(ct, {
                  type: 'line',
                  data: {
                    labels: data_key, // ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
                    datasets: [{
                      label: "Earnings",
                      lineTension: 0.3,
                      backgroundColor: "rgba(231,36,99)",
