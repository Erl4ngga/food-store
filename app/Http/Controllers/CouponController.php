...
class CouponController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Success coupon added');
        }
        else{
            request()->session()->flash('error','Repeat again!!');
        }
    ...
    public function edit($id)
    {
        ...
        if($coupon){
            ...
            return view('backend.coupon.index')->with('error','Coupons are not found');
        }
    }
